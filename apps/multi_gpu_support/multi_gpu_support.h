#ifndef HALIDE_____multi_gpu_support_h
#define HALIDE_____multi_gpu_support_h
#include <stdint.h>
...
int multi_gpu_support(void const *__user_context, struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int multi_gpu_support_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *multi_gpu_support_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return multi_gpu_support_metadata;
}
#endif
